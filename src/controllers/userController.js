...
module.exports = class userController {
  ...
  static async updateUser(req, res) {
    // Desestrutura e recupera os dados enviados e via corpo da requisição
    const { cpf, email, password, name } = req.body;
    ...
    // Se o usuario nao for encontrado userIndex equilave a -1
    if(userIndex === -1){
  ...
  static async deleteUser(req, res) {
   // Obtem o parametro 'id' da requisição, que é o CPF do user
